...
from .views import enter_ride, delete_ride, show_rides, show_reports, CarDay, DriverDay, show_detail, edit_ride, DriverWeek, CarWeek, add_report

urlpatterns = [
    path('add/', enter_ride, name="new_ride"),
    path('added/', enter_ride, name="ride_added"),
    path('list/', show_rides, name="rides_all"),
    # path('reports/', show_reports, name="reports_all"),
