...
from .views import enter_ride, delete_ride, show_rides, add_plan, show_plan, x_plan, show_weeks, show_week_reports,CarDay, DriverDay, show_detail, edit_ride, DriverWeek, CarWeek, add_report, edit_report
